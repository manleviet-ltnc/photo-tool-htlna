...
namespace Manning.MyPhotoAlbum
{
    ...
    public class AlbumStorage
    {
        ...
        static public PhotoAlbum ReadAlbum(string path, string password)
        {
            ...
            try
            {
                ...
                if (password == null || password.Length == 0)
                {
                    ...
                    if (version.EndsWith("e"))
                        throw new AlbumStorageExeption("A password is required to open the album");
                }
                else
                {
            ...
            {
                throw new AlbumStorageExeption ( "Unable to decrypt album " + path, cex);
            }
        ...
        static public bool IsEncrypted(string path)
        {
            ...
            {
                throw new AlbumStorageExeption ("Unable to find album " + path, fnx);
            }
        }
    }
}
